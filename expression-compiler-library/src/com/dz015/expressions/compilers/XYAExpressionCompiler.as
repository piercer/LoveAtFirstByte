package com.dz015.expressions.compilers
{
    ...
    public class XYAExpressionCompiler extends EventDispatcher
    {

        private static var _classNumber:uint = 0;

        public function XYAExpressionCompiler()
        {
        ...
        public function compile( expression:String, tokeniser:IExpressionTokeniser ):void
        {
            ...
            // 3: a
            // 4: pointer to Math
            // 5: temporary for Math.pow parameter 1
            // 6: temporary for Math.pow parameter 2
            //
                    ...
                    case Token.OPERATOR:
                        switch ( token.value )
                        {
                            case '^':
                                ...
                                methodBuilder.addOpcode( Opcode.setlocal, [6] );
                                methodBuilder.addOpcode( Opcode.getlocal, [4] );
                                methodBuilder.addOpcode( Opcode.getlocal, [6] );
